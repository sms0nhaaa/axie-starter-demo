...
import { AxieStarterProps } from '@/types/axie-starter'
...
export function Buba({
  ...
  const animationData = useMemo(() => (ANIMATIONS_DATA as any).buba[animation], [animation])
